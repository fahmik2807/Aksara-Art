...
<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="<?php echo base_url('assets/img/slide1.jpg') ?>" class="d-block w-100" alt="Gotong Royong">
    </div>
    <div class="carousel-item">
      <img src="<?php echo base_url('assets/img/slide2.jpg') ?>" class="d-block w-100" alt="Pure Bali">
    </div>
    <div class="carousel-item">
      <img src="<?php echo base_url('assets/img/slide3.jpg') ?>" class="d-block w-100" alt="Ombak Tinggi">
    </div>
  </div>
      ...
      <div class="card ml-3 mb-3" style="width: 16rem;">
       <img src="<?php echo base_url().'/image/'.$brg->gambar ?>" class="card-img-top" alt="...">
        <div class="card-body">
          ...
          <?php echo anchor('dashboard/tambah_ke_keranjang/' .$brg->id_brg.'/welcome', '<div class="btn btn-primary" id="tambah_chart"> Cart</div>') ?>
