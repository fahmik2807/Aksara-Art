  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?php echo base_url('welcome') ?>">
        ...
        <div class="sidebar-brand-text mx-3">AKSARA ART SHOP</div>
      </a>
      ...
      <!-- Nav Item - Tables -->
      <li class="nav-item">
        <a class="nav-link"  href="<?php echo base_url('kategori/lukisan') ?>">
          <span>LUKISAN</span></a>
      </li>
      <!-- <li class="nav-item"> -->
      ...
      <!-- </li> -->
      <li class="nav-item">
        <a class="nav-link" href="<?php echo base_url('kategori/about') ?>">
          <span>ABOUT US</span></a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="<?php echo base_url('kategori/carabeli') ?>">
              ...
              <div class="topbar-divider d-none d-sm-block"></div>
                ...
                <ul class="nav navbar-nav navbar-right">
                 ...
                 <?php } else { ?>
                  ...
                  <li class="ml-2">|</li>
                  <li class="ml-2"><?php echo anchor('register', 'Register') ?></li>
