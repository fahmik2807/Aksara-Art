...
class Data_brg extends CI_Controller
{
	...
	{
		$data['barang'] = $this->model_barang->tampil_data_galeri($this->session->userdata('id'))->result();
		$this->load->view('admingaleri_templates/header');
		$this->load->view('admingaleri_templates/sidebar');
		$this->load->view('admin_galeri/data_brg', $data);
	...
	public function tambah_aksi()
	{
		...
		redirect('admin_galeri/data_brg/index');
	}
	...
	public function edit($id){
		...
		$this->load->view('admingaleri_templates/header');
		$this->load->view('admingaleri_templates/sidebar');
		$this->load->view('admin_galeri/edit_barang', $data);
		$this->load->view('admingaleri_templates/footer');
	}
